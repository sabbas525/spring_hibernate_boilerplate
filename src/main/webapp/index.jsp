...
<title>Secure Coding - SIT 218 - Severlet example</title>
<style>
.button {
		...
		<div class="login" style="text-align: center;">
			<div class="container">
				<div class="login-form card">
					...
					<h1>Question and Answer Web Application</h1>

					<br>
					<h3 style="color: DodgerBlue; text-align: center;">Please
						select from the following option</h3>
					<br>
					<div class="btn-group" style="text-align: center;">
						<span> <a href="question-answer/showqanda-Form"><button
									type="button" class="button1 button2">Submit Question
									and Answer</button></a> <a href="question-answer/showquery-Form"> <br>

								<button type="button" class="button button2">Query
									Knowledge Database</button></a> <br></span> <br>
					</div>
